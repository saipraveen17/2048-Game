...
public class Tile {
    ...
    private void drawImage() {
        ...
        int drawX = width/2 - getMessageWidth(""+value, font, g)/2;
        int drawY = height/2 + getMessageHeight(""+value, font, g)/2;
    ...
    public void update() {
        if(beginningAnimation) {
            ...
            transform.translate(width/2-scaleFirst*width/2,height-scaleFirst*height/2);
            ...
            AffineTransform transform = new AffineTransform();
            transform.translate(width/2-scaleCombine*width/2,height-scaleCombine*height/2);
